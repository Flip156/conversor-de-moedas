...
public class metodos {
    ...
    public void getConversor(String moeda1, String moeda2, double qnt) throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://v6.exchangerate-api.com/v6/50bad5ba8c775627671f55f7/pair/" + moeda1 + "/" + moeda2 + "/" + qnt))
                .build();
    ...
    public void ListdeCodigo(){
        System.out.println("""
                 Codigo da moeda  |  Nome da moeda     |       País
                $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    ...
    public void menu() {
        System.out.println("""
                ...
                4) - [BRL] Real Brasileiro ⇔ Dólar [USD]
                5) - [USD] Dólar ⇔ Peso Colombiano [COP]
                6) - [COP] Peso Colombiano ⇔ Dólar [USD]
                7) - Histórico de Conversão de Moedas
                8) - Escolher a modeda de Conversão
                9) - Mostrar Lista de Moedas Aceitas
                10) - Sair
                \s""");
    }
